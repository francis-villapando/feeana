...
export function InlineError({ errorMessage }: InlineErrorProps) {
  ...
  return (
    <div className="flex items-start gap-2.5 rounded-md border border-destructive/20 bg-destructive/10 p-3 text-sm text-destructive mt-2 animate-in fade-in-50 duration-150">
