...
export const Route = createFileRoute("/_instructor/history")({
  head: () => ({
    meta: [
      { title: "History — Feeana" },
      {
        name: "description",
        content:
          "Track sentiment improvement and issue persistence across feedback collections.",
      },
    ],
  }),
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Track how teaching adjustments shift sentiment and issue persistence
          over time.
        </p>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card className="border-border/60 bg-card/70 backdrop-blur-xl">
          <CardHeader>
            ...
            <CardDescription>
              Positive vs negative share across sessions.
            </CardDescription>
          </CardHeader>
          <CardContent>
