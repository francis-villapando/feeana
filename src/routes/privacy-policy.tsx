      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
          <section>
            ...
            <p className="mt-2">
              Feeana collects short, free-text feedback that you voluntarily submit during a class
              session.
            </p>
            <ul className="mt-2 list-disc space-y-1 pl-5">
              <li>
                <strong>Tied to session, not your name:</strong> Submissions are associated with the
                class session you select and your authenticated user account (required for
                enrollment). Faculty dashboards display only aggregated analyses — they do not show
                which student submitted what.
              </li>
              <li>
                <strong>Faculty Visibility:</strong> Faculty members see aggregated trend reports,
                issue distributions, and polarity analyses.
              </li>
            </ul>
          </section>
          <section>
            ...
            <p className="mt-2">
              Your text feedback undergoes the following automated processing steps for research
              purposes:
            </p>
            <ul className="mt-2 list-disc space-y-1 pl-5">
              <li>
                <strong>Preprocessing:</strong> Text is cleaned using noise removal, vowel
                normalization, and abbreviation expansion.
              </li>
              <li>
                <strong>Analysis:</strong> Submissions are analyzed for pedagogical issue-driven
                aspect-based sentiment and mapped to Intended Learning Outcomes (ILOs) and
                educational theories (Revised Bloom&#39;s Taxonomy, Cognitive Load Theory, and
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              <li>
                <strong>Cloud Database:</strong> Feedback submissions, account information, and
                analysis results are stored in a Supabase (PostgreSQL) cloud database. Supabase acts
                as a data processor.
              </li>
              <li>
                <strong>No local-only storage:</strong> Data is not limited to browser memory.
                Clearing your browser cache will not delete stored data.
              </li>
              <li>
                <strong>Retention:</strong> Data is retained for the duration of this thesis. There
                is currently no automated deletion mechanism. Contact the researcher below to
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>
                <strong>Data Access &amp; Deletion:</strong> You may request access to or deletion
                of your data by contacting the researcher below.
              </li>
            </ul>
          </section>
          <section>
            ...
            <p className="mt-2">
              If you have any questions, concerns, or requests regarding this research project and
              how data is handled, please contact:
            </p>
            <ul className="mt-2 list-disc space-y-1 pl-5">
