...
-- 10. PARTICIPATION (student submitted for the session)
-- Records the student's participation so submission history is preserved
-- without linking any feedback row to a student identity.
